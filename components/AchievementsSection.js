...
export default function AchievementsSection() {
  return (
    <section id='achievements' className='mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20'>
      <motion.p
      ...
      <div className='mt-8 overflow-hidden rounded-3xl border border-slate-200 bg-white/85 shadow-2xl shadow-slate-900/10 backdrop-blur dark:border-slate-800 dark:bg-slate-900/80 sm:mt-10'>
        ...
        >
          <div className='relative aspect-[4/5] min-h-[360px] overflow-hidden sm:aspect-[16/12] lg:aspect-auto lg:h-full lg:min-h-[640px]'>
            <Image
            ...
            <div className='absolute inset-x-0 bottom-0 bg-gradient-to-t from-slate-950/85 via-slate-950/35 to-transparent p-6'>
              <p className='text-xs font-semibold uppercase tracking-[0.25em] text-brand-200 sm:text-sm'>Winner, Demo Day 7.0</p>
        ...
        >
          <div className='rounded-2xl border border-slate-200 bg-slate-50/80 p-5 dark:border-slate-800 dark:bg-slate-950/40 sm:p-6'>
            ...
            <a
              ...
              className='mt-5 inline-flex w-full items-center justify-center rounded-full bg-brand-600 px-5 py-3 text-sm font-semibold text-white shadow-glow transition hover:bg-brand-700 sm:w-auto'
            >
